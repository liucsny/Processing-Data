...
class Fchart {
  ...
  void display() {
    println(table.getFloat(i,6));//=="北京");
    //if((table.getFloat(i,6)==34.74723141)){//&&(table.getFloat(i,6)!=31.23039505)&&(table.getFloat(i,6)!=23.12906597)&&(table.getFloat(i,6)!=22.54283882)){
...
//line(x,0-l,x,0);//*(1200/52331)+10,l,i*(1200/52331)+10,100);
    ...
    bezier(langtitude+off_x,altitude+off_y, langtitude+off_x ,altitude+off_y-400, x,120+400, x, 120);


    if(table.getFloat(i,4)>r[3]){
      c_l=color(249,121,115,10);
    }else if(table.getFloat(i,4)>r[2]){
      c_l=color(237,151,74,10);
    }else if(table.getFloat(i,4)>r[1]){
      c_l=color(232,239,98,10);
    }else if(table.getFloat(i,4)>r[0]){
      c_l=color(139,239,115,10);
    }else{
      c_l=color(41,204,173,10);
    }
    stroke(c_l);
    float l=map(table.getFloat(i,4),0,10000000,0,100);
    line(x,110-l, x, 110);
  //}
    //textSize(10);
    //fill(0, 0, 0);
